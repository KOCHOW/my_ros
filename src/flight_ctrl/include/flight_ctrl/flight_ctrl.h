...
#include "flight_ctrl/arduino_ulsonic.h"
...
void flight_ctrl_RPYawRate(double, double, double, double);

void key_input_callback(const flight_ctrl::key_input);

void arduino_callback(const flight_ctrl::arduino_ulsonic);
